...
export const BOTTLE_STATUSES: string[] = ["SUR_LATTES", "EN_REMUAGE", "SUR_POINTES", "EN_CAVE", "A_DEGORGER", "DEGORGE", "HABILLE", "PRET_EXPEDITION", "EXPEDIE", "ARCHIVE"];
export const BOTTLE_STATUS_COLORS: any = {
  SUR_LATTES:"#4a7ab5", EN_REMUAGE:"#d48b35", SUR_POINTES:"#e6a15c", EN_CAVE: "#8b1c31", 
  A_DEGORGER:"#c9a84c", DEGORGE:"#4a9fd4", HABILLE:"#9960aa", PRET_EXPEDITION:"#4a9960", EXPEDIE:"#555555", ARCHIVE:"#444444",
};
